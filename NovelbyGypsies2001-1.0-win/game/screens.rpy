...
style window:
    ...
    background Image("images/interface/scene/text_empty.png", xalign=0.5, yalign=1.0)
...
#Minigame Diviner & Mr.Mix
screen level_info:
    
    frame:
       
        vbox:
            text "{color=000000}level:1{/color}"
            text "{color=000000}scores:0{/color}"
...
screen level_info2:
    ...
    frame:
        ...
        vbox:
            text "{color=000000}level:2{/color}"
            text "{color=000000}scores:21{/color}"
...
screen level_info7:
    ...
    frame:
        ...
        vbox:
            text "{color=000000}level:7{/color}"
            text "{color=000000}scores:569{/color}"
...
screen level_info8:
    ...
    frame:
        ...
        vbox:
            ...
            text "{color=000000}scores:1838625612{/color}"
...
screen team():
    ...
    use game_menu(_("Разработчики"), scroll="viewport"):
        ...
        vbox:
            ...
            label "TEAM"
            text _("Директор: Bronyy,Душан Немеч.")
            text _("Разработчик: Душан Немеч.")
            text _("Технический персонал: Хиличурлик.")
            text _("Технический персонал Bot: Umeni Security.")
            text _("Главный персонаж: Danik.")
            text _("Дискорд сервер Разработчика: {a=https://discord.gg/qFxP56yKMN} Blume Corporation.")


style team_label is gui_label
style team_label_text is gui_label_text
style team_text is gui_text

style team_label_text:
...
screen history():
    ...
    use game_menu(_("Мир истории"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
...
transform move_cloud_03:
    xpos 384 ypos 297
    linear 9.0 xpos -381
    xpos 1920
    linear 25.0 xpos 384
    repeat

transform move_cloud_04:
    xpos 882 ypos 78
    linear 15.0 xpos -542
    xpos 1920
    linear 25.0 xpos 882
    repeat

transform move_cloud_05:
    xpos 682 ypos 595
    linear 15.0 xpos -558
    xpos 1920
    linear 25.0 xpos 682
    repeat

transform move_cloud_06:
    xpos 1283 ypos 378
    linear 18.0 xpos -436
    xpos 1920
    linear 25.0 xpos 1283
    repeat

transform move_cloud_07:
    xpos 1678 ypos 580
    linear 20.0 xpos -515
    xpos 1920
    linear 25.0 xpos 1678
    repeat

transform move_cloud_08:
    xpos 1839 ypos 170
    linear 22.0 xpos -475
    xpos 1920
    linear 25.0 xpos 1839
    repeat
...
screen main_menu():
    ...
    add "images/interface/main menu/main_menu.png"
    add "images/interface/main menu/copyright.png"
    
    imagebutton auto "images/interface/main menu/btn_newgame_%s.png" xpos 725 ypos 400 action Start() hover_sound "Audio/Buttons/button_wood.mp3" activate_sound "Audio/Buttons/button_wood.mp3"
    imagebutton auto "images/interface/main menu/btn_loadgame_%s.png" xpos 725 ypos 520 action ShowMenu("load") hover_sound "Audio/Buttons/button_wood.mp3" activate_sound "Audio/Buttons/button_wood.mp3"
    imagebutton auto "images/interface/main menu/btn_options_%s.png" xpos 725 ypos 650 action ShowMenu("preferences") hover_sound "Audio/Buttons/button_wood.mp3" activate_sound "Audio/Buttons/button_wood.mp3"
    imagebutton auto "images/interface/main menu/exit_%s.png" xpos 725 ypos 780 action Quit(confirm=not main_menu) hover_sound "Audio/Buttons/button_wood.mp3" activate_sound "Audio/Buttons/button_wood.mp3"
    imagebutton auto "images/interface/main menu/btn_pers_%s.png" xpos 725 ypos 900 action ShowMenu("team") hover_sound "Audio/Buttons/button_wood.mp3" activate_sound "Audio/Buttons/button_wood.mp3"
    
    add "images/interface/main menu/title.png" xpos 0 ypos 0
################################################################################
## CTC
################################################################################
